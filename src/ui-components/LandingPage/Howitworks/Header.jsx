...
export default function SalesDriverDifference() {
  return (
    <div className="max-w-7xl mx-auto pb-16 pt-16 px-6 md:px-12 text-center">
      <h2 className="text-3xl md:text-[52px] lg:!leading-[4rem] font-black text-gray-900 mb-12 md:mb-14">
