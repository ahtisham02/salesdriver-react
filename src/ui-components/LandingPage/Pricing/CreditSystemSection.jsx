          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="animate-fade-in-left">
              ...
              <div className="space-y-6 mb-10">
                ...
                <p className="text-gray-400 text-base leading-relaxed border-l-2 border-[#00A1E0]/30 pl-6 italic">
              ...
              <div className="grid grid-cols-2 gap-y-4 gap-x-8 mb-12">
                {[
                  ...
                  <div key={idx} className="flex items-center gap-3 group/item">
                    ...
                    <span className="text-gray-300 text-sm font-semibold tracking-wide group-hover/item:text-white transition-colors">{item}</span>
                  </div>
                ))}
              </div>
              ...
              <div className="flex flex-wrap gap-5">
                <button className="px-10 py-4 bg-[#00A1E0] text-white font-bold rounded-full hover:bg-[#0088CC] transition-all duration-300 shadow-lg shadow-[#00A1E0]/20 hover:shadow-xl hover:shadow-[#00A1E0]/40 transform hover:-translate-y-1">
                  Buy Credits
                </button>
                <button className="px-10 py-4 bg-transparent border-2 border-white/10 text-white font-bold rounded-full hover:bg-white/5 hover:border-white/30 transition-all duration-300 flex items-center gap-2 group transform hover:-translate-y-1">
                  View Plans
